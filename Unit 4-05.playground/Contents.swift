...
class ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        instructionLabel.text = "Enter radius and height of cylinder in cm"
        ...
        enterButton.centerXAnchor.constraint(equalTo: view.centerXAnchor,constant: 20).isActive = true
        enterButton.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 20).isActive = true
